...
{
	Object *app, *window, *cm1, *cm2, *bt1, *bt2, *lbl1, *lbl2, *txt1, *txt2;
	...
	Child, VGroup,
		Child, HGroup,// First row with multiple items
		Child, lbl1 = Label("Dog"),
		Child, txt1 = StringObject,	StringFrame, MUIA_String_Contents, "", MUIA_String_MaxLen, 100, End,
		Child, cm1 = CheckMark(TRUE),
		End,

		Child, HGroup, // 2nd row with multiple items
		Child, lbl2 = Label("Cat"),
		Child, txt2 = StringObject, StringFrame, MUIA_String_Contents, "", MUIA_String_MaxLen, 100, End,
